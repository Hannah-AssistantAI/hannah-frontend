...
import '../modals/FlagMessageModal.css'

interface FlagQuizModalProps {
    isOpen: boolean
    onClose: () => void
...
export function FlagQuizModal({ isOpen, onClose, onSubmit, isSubmitting, quizTitle }: FlagQuizModalProps) {
        ...
        <div className="flag-modal-overlay" onClick={handleClose}>
            <div className="flag-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="flag-modal-content">
                    {quizTitle && (
                        <p className="flag-modal-quiz-title">
                            <strong>Bài kiểm tra:</strong> {quizTitle}
                        </p>
                    )}

                    <p className="flag-modal-description">
                        Vui lòng cho chúng tôi biết lý do tại sao bạn muốn báo cáo bài kiểm tra này:
                    </p>
