...
// Python API Base URL - routes through API Gateway (same as VITE_API_BASE_URL)
export const PYTHON_API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://localhost:8001';
